...
function SideContentBlock() {
  return <><div className='side__user-info'><img src={background}/><img src={userpic} className='side__user-pic'/><div className='side__user-info__text'>
    ...
    <div className='side__new-article'><button className='new-article__button button__blue text__small'>{('write new article').toUpperCase()}</button></div></>;
}
